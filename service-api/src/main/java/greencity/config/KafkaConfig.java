...
public class KafkaConfig {
     ...
     *
     * @return ConsumerFactory for NotificationEvent
     */
    @Bean
    public ConsumerFactory<String, NotificationEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "greencity.notification.model");
     ...
     *
     * @return ConcurrentKafkaListenerContainerFactory for NotificationEvent
     */
    @Bean
